...
{
    public class DerivedOffNormalAlarmTypeHolder : OffNormalAlarmTypeHolder
    {
        public DerivedOffNormalAlarmTypeHolder(
            ...
            base(alarms, parent, trigger, name, alarmConditionType, controllerType, interval, optional, maxShelveTime, false)
        {
            if (create)
            {
                Initialize(AlarmHelpers.GetDerivedIdentifier(Opc.Ua.ObjectTypes.OffNormalAlarmType), name, maxShelveTime);
            }
        }
